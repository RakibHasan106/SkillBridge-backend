/*
  ...
  - You are about to drop the column `categoryId` on the `tutors` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "tutors" DROP COLUMN "categoryId",
...
-- AddForeignKey
ALTER TABLE "_CategoryToTutorProfile" ADD CONSTRAINT "_CategoryToTutorProfile_B_fkey" FOREIGN KEY ("B") REFERENCES "tutors"("id") ON DELETE CASCADE ON UPDATE CASCADE;
